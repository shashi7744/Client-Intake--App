...
import { UserPlus, Users, ShieldCheck, Lock, Crown, LayoutGrid, Bell, UserCog, ClipboardList } from "lucide-react";
...
export default function Sidebar({
  ...
  // Admin role always has full access, regardless of membership payment.
  ...
  return (
    <aside className="w-64 shrink-0 bg-slate-900 text-slate-300 flex flex-col min-h-screen">
      <div className="px-6 py-6 border-b border-slate-800">
        ...
        <p className="text-[11px] tracking-wider text-slate-500 mt-1 uppercase">
